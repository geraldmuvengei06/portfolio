                                    ...
                                    <div className="flex items-center justify-between w-full md:w-auto">
                                        <a href="#">
                                            ...
                                            <img
                                                ...
                                                src="https://tailwindui.com/img/logos/workflow-mark-red-400.svg"
                                            />
                                        </a>
                        ...
                        >
                            ...
                            >
                                <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                                    ...
                                    <a
                                        href="#"
                                        className="block w-full px-5 py-3 text-center font-medium text-red-400 bg-gray-50 hover:bg-gray-100"
                                    >
                                        Log in
                                    </a>
                                </div>
